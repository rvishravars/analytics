...
stats_df = pd.read_csv("data/github_projects_stats.csv")
sizes_df = pd.read_csv("data/ci_theater_project_sizes.csv")
...
plt.tight_layout()
plt.savefig("data/time_to_first_ci_by_size.png", dpi=300, bbox_inches="tight")
