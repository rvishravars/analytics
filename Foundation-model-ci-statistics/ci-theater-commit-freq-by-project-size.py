...
commit_freq_df = pd.read_csv("data/ci_theater_commit_frequency.csv")
project_sizes_df = pd.read_csv("data/ci_theater_project_sizes.csv")
...
plt.legend()
plt.tight_layout()
plt.savefig("data/avg_commit_frequency_by_size.png", dpi=300, bbox_inches='tight')
