...
commit_freq_df = pd.read_csv("data/20_ci_theater_commit_frequency_rust.csv")
project_sizes_df = pd.read_csv("data/19_ci_theater_project_sizes_rust.csv")
...
plt.legend()
plt.tight_layout()
plt.savefig("data/21_1_avg_commit_frequency_by_size_rust.png", dpi=300, bbox_inches='tight')
