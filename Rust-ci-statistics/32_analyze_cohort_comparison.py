...
def get_args():
    ...
    parser = argparse.ArgumentParser(description="Compare CI health metrics between monoglot and polyglot Rust projects.")
    parser.add_argument("--output-dir", default="figures/polyglot_comparison", help="Directory to save the output plots.")

    # Commit Frequency
    parser.add_argument("--commit-freq-mono", default="data/20_commit_frequency_monoglot.csv")
    parser.add_argument("--commit-freq-poly", default="data/20_commit_frequency_polyglot.csv")

    # Build Duration
    parser.add_argument("--build-duration-mono", default="data/22_build_durations_monoglot.csv")
    parser.add_argument("--build-duration-poly", default="data/22_build_durations_polyglot.csv")

    # Test Coverage
    parser.add_argument("--coverage-mono", default="data/24_test_coverage_monoglot.csv")
    parser.add_argument("--coverage-poly", default="data/24_test_coverage_polyglot.csv")

    # Broken Builds
    parser.add_argument("--broken-builds-mono", default="data/28_broken_build_stats_monoglot.csv")
    parser.add_argument("--broken-builds-poly", default="data/28_broken_build_stats_polyglot.csv")

    # Bug Issues
    parser.add_argument("--bugs-mono", default="data/31_bug_issues_monoglot.csv")
    parser.add_argument("--bugs-poly", default="data/31_bug_issues_polyglot.csv")
